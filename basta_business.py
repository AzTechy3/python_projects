class Menu():
  ...
  def __repr__(self):
    return self.name + " available from " + str(self.start_time) + ":00am until " + str(self.end_time) + ":00pm"
...
arepas_menu = Menu('Take a Arepa Menu', {'arepa pabellon': 7.00, 'pernil arepa': 8.50, 'guayanes arepa': 8.00, 'jamon arepa': 7.50}, 10, 20)
